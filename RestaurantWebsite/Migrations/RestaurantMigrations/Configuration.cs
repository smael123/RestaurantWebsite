namespace RestaurantWebsite.Migrations.RestaurantMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RestaurantWebsite.Persistence.RestaurantContext>
    {
        ...
        protected override void Seed(RestaurantWebsite.Persistence.RestaurantContext context)
        {
            ...
            //context.Foods.AddOrUpdate(c => c.Name,
            //    new Food {
            //        Name = "Taco",
            //        Description = "Comes with your choice of tortilla and filling.",
            //        BasePrice = 1.79m,
            ...
            //            new Extra {
            //                Name = "Chopped Tampiquena",
            //                Description = "Tampiquena Filling",
            //                AddedPrice = 0.96m
            //            }
            //        }
            //    },
            ...
            //            new Extra {
            //                Name = "Extra Steak",
            //                Description = "Get an extra steak on your plate.",
            //                AddedPrice = 6.99m
            //            }
            //        }
            //    },
            ...
            //            new Extra {
            //                Name = "Large Bowl",
            //                Description = "Get a large bowl of menudo",
            //                AddedPrice = 1
            //            },
            //            new Extra {
            //                Name = "Extra Hominy",
            //                Description = "Get extra hominy in your menudo bowl.",
            //                AddedPrice = 0.99m
            //            }
            //        }
            //    },
            ...
            //context.Specials.AddOrUpdate(c => c.Name,
            //    new Special
            //    {
            //        Name = "Half Off Tacos",
            //        Description = "For a limited time, all tacos are half off. Extras not included.",
